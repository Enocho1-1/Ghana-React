        ...
        <Modal>
            ...
            <section>
                ...
                <div className="explore-text">
                    <img src={Ancientmap} alt="Ancient Ghana Map" style={{float:"left"}}/>
            ...
            <section>
                ...
                <hr />
                <div className="explore-text">
                    <img src={Goldenstool} alt="Golden Stool" style={{float:"right"}}/>
            ...
            <section>
                ...
                <hr />
                <div className="explore-text">
                    <img src={King} alt="King Kanaissa ai" style={{float:"left"}}/>
            ...
            <section>
                <h1 className="explore-head">Trans-Saharan Trade</h1> 
                    <hr />
                <div className="explore-text">
                    <img src={Trade} alt="King Kanaissa ai" style={{float:"right"}}/>
